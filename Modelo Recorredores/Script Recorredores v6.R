...
datos = read.xls ("Modelo de sensibilidad vR Final.xlsm", sheet = 1, header = FALSE)
variables = read.xls ("Modelo de sensibilidad vR Final.xlsm", sheet = 2, header = FALSE)
rutas = read.xls ("Modelo de sensibilidad vR Final.xlsm", sheet = 3, header = TRUE)
puntos = read.xls ("Modelo de sensibilidad vR Final.xlsm", sheet = 4, header = TRUE)
coord = read.xls ("Modelo de sensibilidad vR Final.xlsm", sheet = 6, header = TRUE)

# read table with categories display
categorias <- read.xls ("Modelo de sensibilidad vR Final.xlsm", sheet = 8, header = TRUE)
...
wb <- loadWorkbook("Modelo de sensibilidad vR Final.xlsm")
sheets <- getSheets(wb)
...
saveWorkbook(wb, "Modelo de sensibilidad vR Final.xlsm")
